...
class GetStartedCollectionViewController: UICollectionViewController, UICollectionViewDelegateFlowLayout {
    ...
    private func setupConfig() {
        getStartedConfigArray =
            [GetStartedConfig(title: "gs.verifier.step0.title".localized, detail: "gs.verifier.step0.message".localized, image: UIImage(named: "step0"), finished: false),
            GetStartedConfig(title: "gs.verifier.step1.title".localized, detail: "gs.verifier.step1.message".localized, image: UIImage(named: "step1"), finished: false),
            GetStartedConfig(title: "gs.verifier.step2.title".localized, detail: "gs.verifier.step2.message".localized, image: UIImage(named: "step2"), finished: false),
            GetStartedConfig(title: "gs.verifier.step3.title".localized, detail: "gs.verifier.step3.message".localized, image: UIImage(named: "step3"), finished: true)]
    }
