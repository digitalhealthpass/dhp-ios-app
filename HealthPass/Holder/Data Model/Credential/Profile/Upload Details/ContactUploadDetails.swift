...
struct ContactUploadDetails: Codable {
    enum CodingKeys: String, CodingKey {
        case contactID, associatedCredentials
    }

    var contactID: String?
    var associatedCredentials: [String]?
    ...
    init(value: [String: Any]) {
        ...
        associatedCredentials = value["associatedCredentials"] as? [String]
    }
